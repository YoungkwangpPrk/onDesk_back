package com.com4in.itsm.saptoken;
...
public class SAMLAssertionGen {

    public String getGenStart(String tokenUrl, String clientId, String userId, String username, String privateKey,
                              int expireInMinutes) {
        try {
